            ...
            child: Form(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    containerFlexible(nameCity, "Cidade", "",TextInputType.text, aqi, "AQI", "",TextInputType.number),
                    containerFlexible(date, "Data", "dd/mm/yyyy",TextInputType.number, time, "Hora", "00:00:00:00",TextInputType.number),
                    containerFlexible(lat, "Latitude", "",TextInputType.number, long, "Longitude", "",TextInputType.number),
                        ...
                        onPressed: ()async{
                          ...
                          if(_formKey.currentState.validate()){
                            ...
                            Scaffold.of(context)..showSnackBar(new SnackBar(
                              content: Text("Informação inserida com sucesso!"),
